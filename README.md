...
I would improve watchlistCheck so it matched addresses. At first it had more functionality (with arrays), then I adapted it to return simpler information. I got as far as asking in Discord's subgraph-development for help with this but unfortunately ran out of time.

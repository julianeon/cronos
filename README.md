...
After that, I introduced a new entity called Info, which is defined as an entity in [schema.graphql](schema.graphql) and has an associated function in [src/cro-token.js](src/cro-token.ts).
